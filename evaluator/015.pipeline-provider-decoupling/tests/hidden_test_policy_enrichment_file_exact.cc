...
int main() {
  ...
  config.policy_file_path = "evaluator/015.pipeline-provider-decoupling/data/policies.json";
  ...
  const auto expected =
      case015_test::ReadExpectedLines("evaluator/015.pipeline-provider-decoupling/data/expected_output_file.txt");
